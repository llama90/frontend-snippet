<template>
    <div>
        ...
        <div class="form-group text-center">
            ...
            <label class="form-check-label">Show Shipped Orders</label></div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState({orders: state => state.orders.orders}), displayOrders() {
                return this.showShipped ? this.orders
                    : this.orders.filter(o => o.shipped != true);
            }
        },
        methods: {
            ...mapMutations(["changeOrderShipped"]), ...mapActions(["getOrders", "updateOrder"]), getTotal(order) {
